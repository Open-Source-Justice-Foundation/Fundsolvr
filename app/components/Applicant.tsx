        ...
        <div className="flex gap-x-4">
          ...
          {githubVerified && (
            ...
            >
              ...
              GitHub
              <span className="absolute right-0 top-0 block h-2.5 w-2.5 rounded-full bg-green-500 ring-2 ring-gray-100 dark:bg-green-400 dark:ring-gray-800">
                <CheckCircleIcon className="h-full w-full text-gray-100 dark:text-gray-800" />
              </span>
            </a>
          )}
        </div>
