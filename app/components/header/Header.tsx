...
export default function Header() {
  ...
  return (
    <div className="container mx-auto flex max-w-7xl flex-col px-4">
      <div className="top-0 z-40 flex h-16 w-full shrink-0 items-center gap-x-4 py-14 shadow-sm">
        <div className="flex flex-1 justify-end gap-x-4 self-stretch px-4">
          <div className="flex w-full items-center justify-between">
            ...
            <div className="flex items-center gap-x-6">
              <button onClick={navigateToCreate} className="rounded-full bg-indigo-600 px-4 py-2 font-medium text-white hover:bg-indigo-500">
                + Bounty
              </button>
              <Login>
