...
export default function BountyTabs() {
  ...
  return (
    <div className="flex w-full max-w-screen-xl justify-start gap-x-2 overflow-auto border-b border-gray-300 px-2 pb-3 text-gray-600 dark:border-darkBorder dark:text-gray-300 md:overflow-hidden">
      <div
        onClick={switchToAll}
        className={classNames(
          ...
          "flex cursor-pointer select-none items-center gap-x-2 border-r border-gray-400 pr-2 dark:border-darkBorder dark:hover:text-gray-100"
        )}
      >
