...
const ChatPage = () => {
  ...
  return (
    <>
      <div className="flex items-center border-b border-b-gray-300 bg-white dark:bg-gray-800 dark:border-b-gray-700">
        <div className="flex w-full items-center gap-4 p-2 pb-4">
          <button onClick={() => router.back()} className="rounded p-1 transition-colors hover:bg-gray-50 dark:hover:bg-gray-700">
      ...
      <div className="flex h-full max-h-[66vh] flex-col items-center gap-4 overflow-auto p-4">
        <span className="py-2 text-xs text-gray-700 dark:text-gray-400">Yesterday at 1:02 PM</span>
        ...
        />
        <span className="py-2 text-xs text-gray-700 dark:text-gray-400">Today at 11:16 AM</span>
      ...
      <div className="flex items-center gap-4 p-4">
        <div className="flex-1 rounded-md bg-white dark:bg-white/5 ring-1 ring-inset ring-gray-300 dark:ring-white/10 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500">
          <input
            type="text"
            className="w-full border-0 bg-transparent px-4 py-2 text-gray-800 dark:text-white focus:ring-0 sm:text-sm sm:leading-6"
