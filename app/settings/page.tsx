...
export default function Settings() {
  ...
  async function connectGithub(e: any) {
    ...
    // console.log("data", gist.data);
    const files = gist.data.files;
    // console.log("login", gist.data.owner?.login);
    if (files) {
  ...
  useEffect(() => {
    setGithub(getUserProfile(relayUrl).github);
  }, []);
            ...
            <div className="divide-y divide-white/5">
              ...
              <div className="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8">
                ...
                <div>
                  {/* TODO: add octicon*/}
                  {github ? (
                    <div className="mt-6 flex gap-2 text-green-300">
                      <svg className="fill-green-300" width="24" height="24" viewBox="0 0 24 24">
